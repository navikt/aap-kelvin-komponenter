...
public object InitTestDatabase  : Closeable {
    ...
    public fun freshDatabase(): DataSource {
        ...
        val ferskUrl = (clerkDataSource as HikariConfig).jdbcUrl
        println("Startet fresh Postgres med URL $ferskUrl. Brukernavn: ${postgres.username}. Passord: ${postgres.password}. Db-navn: $databaseName")
